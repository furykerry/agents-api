...
type SandboxTemplateLister interface {
	...
	List(selector labels.Selector) (ret []*agentsv1alpha1.SandboxTemplate, err error)
...
type sandboxTemplateLister struct {
	listers.ResourceIndexer[*agentsv1alpha1.SandboxTemplate]
}
...
func NewSandboxTemplateLister(indexer cache.Indexer) SandboxTemplateLister {
	return &sandboxTemplateLister{listers.New[*agentsv1alpha1.SandboxTemplate](indexer, agentsv1alpha1.Resource("sandboxtemplate"))}
}

// SandboxTemplates returns an object that can list and get SandboxTemplates.
func (s *sandboxTemplateLister) SandboxTemplates(namespace string) SandboxTemplateNamespaceLister {
	return sandboxTemplateNamespaceLister{listers.NewNamespaced[*agentsv1alpha1.SandboxTemplate](s.ResourceIndexer, namespace)}
}
...
type SandboxTemplateNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*agentsv1alpha1.SandboxTemplate, error)
