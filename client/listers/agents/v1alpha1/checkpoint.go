...
type CheckpointLister interface {
	...
	List(selector labels.Selector) (ret []*agentsv1alpha1.Checkpoint, err error)
...
type checkpointLister struct {
	listers.ResourceIndexer[*agentsv1alpha1.Checkpoint]
}

// NewCheckpointLister returns a new CheckpointLister.
func NewCheckpointLister(indexer cache.Indexer) CheckpointLister {
	return &checkpointLister{listers.New[*agentsv1alpha1.Checkpoint](indexer, agentsv1alpha1.Resource("checkpoint"))}
}

// Checkpoints returns an object that can list and get Checkpoints.
func (s *checkpointLister) Checkpoints(namespace string) CheckpointNamespaceLister {
	return checkpointNamespaceLister{listers.NewNamespaced[*agentsv1alpha1.Checkpoint](s.ResourceIndexer, namespace)}
}
...
type CheckpointNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*agentsv1alpha1.Checkpoint, error)
