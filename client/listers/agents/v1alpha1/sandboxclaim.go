...
type SandboxClaimLister interface {
	...
	List(selector labels.Selector) (ret []*agentsv1alpha1.SandboxClaim, err error)
...
type sandboxClaimLister struct {
	listers.ResourceIndexer[*agentsv1alpha1.SandboxClaim]
}
...
func NewSandboxClaimLister(indexer cache.Indexer) SandboxClaimLister {
	return &sandboxClaimLister{listers.New[*agentsv1alpha1.SandboxClaim](indexer, agentsv1alpha1.Resource("sandboxclaim"))}
}

// SandboxClaims returns an object that can list and get SandboxClaims.
func (s *sandboxClaimLister) SandboxClaims(namespace string) SandboxClaimNamespaceLister {
	return sandboxClaimNamespaceLister{listers.NewNamespaced[*agentsv1alpha1.SandboxClaim](s.ResourceIndexer, namespace)}
}
...
type SandboxClaimNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*agentsv1alpha1.SandboxClaim, error)
